...
if DEFINED _Office%1Path (
    ...
    cscript //nologo ospp.vbs /sethst:192.168.1.48 >nul
...
if defined %EditionID% (
	...
	cscript //Nologo %windir%\system32\slmgr.vbs /skms 192.168.1.48
